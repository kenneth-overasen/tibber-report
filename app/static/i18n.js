...
const I18N = {
  en: {
    ...
    "ui.price_is": "Price is",
    "ui.incl_vat": "including VAT",
    "ui.excl_vat": "excluding VAT",
    "ui.vat_rate": "VAT rate %",
    "ui.auto": "auto",
    "ui.vat_hint":
      "Leave the VAT rate empty to use the rate derived from the API data " +
      "(25 % in most of Norway, 0 % in Nordland/Troms/Finnmark).",
    ...
    "ui.tile_fixed_incl": "Fixed incl. VAT",
    ...
    "ui.col_fixed": "Fixed incl. VAT ({currency})",
    "ui.row_excl": "Excl. VAT",
    "ui.row_vat": "VAT",
    "ui.row_vat_rate": "VAT ({rate})",
    "ui.row_total": "Total incl. VAT",
    "ui.total": "TOTAL",
    ...
    "ui.sub_fixed_vat": "fixed VAT {rate}",
  ...
  nb: {
    ...
    "ui.price_is": "Prisen er",
    "ui.incl_vat": "inkludert MVA",
    "ui.excl_vat": "eksklusiv MVA",
    "ui.vat_rate": "MVA-sats %",
    "ui.auto": "auto",
    "ui.vat_hint":
      "La MVA-satsen stå tom for å bruke satsen som utledes fra API-dataene " +
      "(25 % i det meste av Norge, 0 % i Nordland/Troms/Finnmark).",
    ...
    "ui.tile_fixed_incl": "Fastpris inkl. MVA",
    ...
    "ui.col_fixed": "Fastpris inkl. MVA ({currency})",
    "ui.row_excl": "Eks. MVA",
    "ui.row_vat": "MVA",
    "ui.row_vat_rate": "MVA ({rate})",
    "ui.row_total": "Totalt inkl. MVA",
    "ui.total": "TOTALT",
    ...
    "ui.sub_fixed_vat": "fastpris-MVA {rate}",
