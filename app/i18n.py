...
CATALOGUE: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "rep.fixed_detail": "{incl} {currency}/kWh incl. VAT ({excl} excl. VAT{extra})",
        "rep.fixed_vat_extra": ", VAT {rate}",
        "rep.details": "Details",
        "rep.summary": "Summary",
        ...
        "rep.fixed_total_incl": "Fixed total incl. VAT ({currency})",
        "rep.fixed_total_excl": "Fixed total excl. VAT ({currency})",
        "rep.fixed_vat": "Fixed VAT ({currency})",
        "rep.difference": "Difference, fixed - spot ({currency})",
        ...
        "rep.fixed_cost_incl": "Fixed cost incl. VAT ({currency})",
        "rep.fixed_cost_excl": "Fixed cost excl. VAT ({currency})",
        "rep.fixed_cost_vat": "Fixed VAT ({currency})",
        ...
        "rep.total_incl_vat": "Total incl. VAT",
        "rep.total": "TOTAL",
        "rep.consumption": "Consumption",
        "rep.spot_tile": "Spot total incl. VAT",
        "rep.fixed_tile": "Fixed total incl. VAT",
        ...
        "err.negative_vat": "The VAT rate cannot be negative.",
    ...
    "nb": {
        ...
        "rep.fixed_detail": "{incl} {currency}/kWh inkl. MVA ({excl} eks. MVA{extra})",
        "rep.fixed_vat_extra": ", MVA {rate}",
        ...
        "rep.fixed_total_incl": "Fastpris totalt inkl. MVA ({currency})",
        "rep.fixed_total_excl": "Fastpris totalt eks. MVA ({currency})",
        "rep.fixed_vat": "MVA fastpris ({currency})",
        "rep.difference": "Differanse, fastpris - spot ({currency})",
        ...
        "rep.fixed_cost_incl": "Fastpriskostnad inkl. MVA ({currency})",
        "rep.fixed_cost_excl": "Fastpriskostnad eks. MVA ({currency})",
        "rep.fixed_cost_vat": "MVA fastpris ({currency})",
        ...
        "rep.total_incl_vat": "Totalt inkl. MVA",
        "rep.total": "TOTALT",
        "rep.consumption": "Forbruk",
        "rep.spot_tile": "Spot totalt inkl. MVA",
        "rep.fixed_tile": "Fastpris totalt inkl. MVA",
        ...
        "err.negative_vat": "MVA-satsen kan ikke være negativ.",
